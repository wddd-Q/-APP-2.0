...
func _load_positions() -> void:
	sect_positions = {
		...
		"副长老": {"salary": 12, "min_realm": 1, "rank_unlock": 9, "max_count": 1, "bonus": "event_advice", "bonus_value": 0.10, "description": "协助处理宗门纪事，性格会影响其处置判断"},
		"长老": {"salary": 20, "min_realm": 2, "rank_unlock": 8, "max_count": 2, "bonus": "teaching_boost", "bonus_value": 0.10, "description": "指导弟子修炼，传授功法"},
		"护法": {"salary": 10, "min_realm": 1, "rank_unlock": 9, "max_count": 2, "bonus": "defense_boost", "bonus_value": 0.10, "description": "守护山门，抵御外敌"},
